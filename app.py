...
#@st.cache(hash_funcs={st.delta_generator.DeltaGenerator: prediction})
...
def main():       
    ...
    <h1 style ="color:black;text-align:center;">Streamlit Sql Injection attack ML App</h1> 
    </div> 
    """
